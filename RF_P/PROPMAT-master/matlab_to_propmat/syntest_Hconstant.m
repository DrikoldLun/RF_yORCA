...
RF_stack_dir = '../../PCA/stack/RF50_0.10to2.00/';
%RF_stack_path = fullfile(RF_stack_dir,['XX.',sta{i},'_PCA.dat']);
RF_stack_path = fullfile(RF_stack_dir,['Hconstant_',sta{i},'.dat']);
...
plotZR(RF_pm,1,[3,2],i,samprate,2,10,'red',[sta{i},' (syn\_Moho=',num2str(moho(i)),',sedh=',num2str(sed(i)),',sedVs=',num2str(sedVs(i)),')']);
