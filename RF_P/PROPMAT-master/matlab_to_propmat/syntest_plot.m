...
RF_stack_path = fullfile(RF_stack_dir,[sta{i},'_PCA.dat']);
...
R_pm = cutP(R_pm,amp_pm,samprate,2,10);
Z_pm = cutP(Z_pm,amp_pm,samprate,2,10);
alpha = 5;
...
plotZR(RF_pm,1,[length(moho),1],i,samprate,2,10,'red',[sta{i},' (syn\_Moho=',num2str(moho(i)),'km)']);
